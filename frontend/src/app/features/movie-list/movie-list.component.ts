...
@Component({
    ...
    <div class="netflix-browse">
      ...
      @if (store.loading()) {
        ...
        @if (store.featuredMovie(); as featured) {
          <section class="hero" [style.background-image]="'url(' + (featured.thumbnailUrl || '') + ')'">
            ...
            <div class="hero-content">
              ...
              <div class="hero-actions">
                ...
                <button pButton class="info-btn" [outlined]="true" [routerLink]="['/movie', featured.id]">
              ...
              <div class="row-wrapper">
                ...
                <div class="movies-row">
                  @for (movie of category.movies; track movie.id) {
                    <div class="movie-card" [class.cached]="movie.cached" [routerLink]="['/movie', movie.id]">
  ...
  styles: [`
    ...
    .card-overlay {
      position: absolute;
      inset: 0;
      background: linear-gradient(0deg, rgba(20,20,20,0.95) 0%, rgba(20,20,20,0.7) 50%, transparent 100%);
      opacity: 0;
